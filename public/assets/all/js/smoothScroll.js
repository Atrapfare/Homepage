(function () {
    ...
    function R(a) {
        ...
        var d = -a.wheelDeltaX ||
            a.deltaX || 0, c = -a.wheelDeltaY || a.deltaY || 0;
    ...
    function P(a) {
        a *= f.pulseScale;
        if (1 > a) var b =
            a - (1 - Math.exp(-a)); else b = Math.exp(-1), a = 1 - Math.exp(-(a - 1)), b += a * (1 - b);
    ...
    var aa = {
            ...
            fixedBackground: !0,
            excluded: ""
        }, f = aa, v = !1, B = {x: 0, y: 0}, D = !1, l = document.documentElement, m, z, w, h = [], Z,
        ha = /^Mac/.test(navigator.platform), g = {
            left: 37, up: 38, right: 39, down: 40,
            spacebar: 32, pageup: 33, pagedown: 34, end: 35, home: 36
        }, ja = {37: 1, 38: 1, 39: 1, 40: 1}, t = [], F = !1, E = Date.now(), J = function () {
            var a = 0;
            return function (b) {
    ...
    var Q = function () {
        ...
        window.WebKitMutationObserver || window.MozMutationObserver, O = function () {
    ...
    u = /safari/i.test(k) &&
        !u;
    var ka = /mobile/i.test(k), la = /Windows NT 6.1/i.test(k) && /rv:11/i.test(k),
